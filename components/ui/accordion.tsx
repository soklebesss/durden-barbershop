...
>(({ className, ...props }, ref) => (
  <AccordionPrimitive.Item
    ref={ref}
    className={cn("border-b border-[var(--border-inverted)]", className)}
    {...props}
  />
));
...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 cursor-pointer items-center justify-between gap-4 py-5 text-left font-display text-xl uppercase transition-colors hover:text-accent-ink [&[data-state=open]>svg]:rotate-45",
        className
      )}
      {...props}
    >
